...
//   return (
//     <div
//       className="relative min-h-screen bg-gradient-to-br from-white to-sky-50"
//       ref={appRef}
//     >
...
//         {showCart && (
//           <div className="fixed top-0 right-0 bottom-0 z-50 w-full md:w-96 bg-white shadow-2xl overflow-y-auto">
//             <Cart
//               cart={cart}
//               removeFromCart={removeFromCart}
//               addToCart={addToCart}
